                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="processa/update.php" method="POST">
                                        <input hidden readonly id="idZabbix" name="idZabbix" value="<?= $id ?>">
                                        <div class="row">
                                            <div class="col-6">
                                                <label for="descricaoZabbix" class="form-label">Descrição</label>
                                                <input required value="<?= $c_integracao_zabbix['descricao'] ?>" name="descricaoZabbix" id="descricaoZabbix" class="form-control" type="text">
                                            </div>
                                            <div class="col-3">
