                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="col-12">
                                                    <span><b>Quadros e Tarefas</b></span>
                                                </div>
                                                <?php
                                                $submenu_quadros_tarefas =
                                                    "SELECT us.id as idSubmenu, us.url as urlSubmenu, us.submenu as submenu
                                                FROM url_submenu as us
                                                WHERE us.menu_id = 29
                                                ORDER BY us.submenu ASC";
                                                $r_submenu_quadros_tarefas = mysqli_query($mysqli, $submenu_quadros_tarefas);
                                                while ($c_submenu_quadros_tarefas = mysqli_fetch_assoc($r_submenu_quadros_tarefas)) {
                                                    $idSubmenu = $c_submenu_quadros_tarefas['idSubmenu'];
                                                ...
                                                ";
                                                    ...
                                                    if ($c_valida_check['validaCheck'] <> "0") { ?>
                                                        <div class="col-12">
                                                            <div class="form-check">
                                                                <input onclick="despermitirSubmenu(<?= $c_valida_check['idPermissao'] ?>)" class="form-check-input" type="checkbox" id="submenu<?= $idSubmenu ?>" checked data-bs-toggle="modal" data-bs-target="#modalDespermitirSubmenu">
                                                                <label class="form-check-label" for="submenu<?= $idSubmenu ?>"><?= $c_submenu_quadros_tarefas['submenu'] ?></label>
                                                            </div>
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="col-12">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                WHERE us.menu_id = 36
                                                ORDER BY us.submenu ASC";
                                                $r_submenu_vault = mysqli_query($mysqli, $submenu_vault);
                                                while ($c_submenu_vault = mysqli_fetch_assoc($r_submenu_vault)) {
                                                    $idSubmenu = $c_submenu_vault['idSubmenu'];
                                                ...
                                                ";
                                                    ...
                                                    if ($c_valida_check['validaCheck'] <> "0") { ?>
                                                        <div class="col-12">
                                                            <div class="form-check">
                                                                <input onclick="despermitirSubmenu(<?= $c_valida_check['idPermissao'] ?>)" class="form-check-input" type="checkbox" id="submenu<?= $idSubmenu ?>" checked data-bs-toggle="modal" data-bs-target="#modalDespermitirSubmenu">
                                                                <label class="form-check-label" for="submenu<?= $idSubmenu ?>"><?= $c_submenu_vault['submenu'] ?></label>
                                                            </div>
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="col-12">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                WHERE us.menu_id = 38
                                                ORDER BY us.submenu ASC";
                                                $r_submenu_orcamento = mysqli_query($mysqli, $submenu_orcamento);
                                                while ($c_submenu_orcamento = mysqli_fetch_assoc($r_submenu_orcamento)) {
                                                    $idSubmenu = $c_submenu_orcamento['idSubmenu'];
                                                ...
                                                ";
                                                    ...
                                                    if ($c_valida_check['validaCheck'] <> "0") { ?>
                                                        <div class="col-12">
                                                            <div class="form-check">
                                                                <input onclick="despermitirSubmenu(<?= $c_valida_check['idPermissao'] ?>)" class="form-check-input" type="checkbox" id="submenu<?= $idSubmenu ?>" checked data-bs-toggle="modal" data-bs-target="#modalDespermitirSubmenu">
                                                                <label class="form-check-label" for="submenu<?= $idSubmenu ?>"><?= $c_submenu_orcamento['submenu'] ?></label>
                                                            </div>
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="col-12">
