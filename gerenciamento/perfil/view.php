                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2">
                                            ...
                                            ORDER BY
                                                us.submenu ASC";
                                            $r_submenu_localidade = mysqli_query($mysqli, $submenu_localidade);
                                            while ($c_submenu_localidade = mysqli_fetch_assoc($r_submenu_localidade)) {
                                                $idSubmenu = $c_submenu_localidade['idSubmenu'];
                                                ...
                                                if ($c_valida_check['validaCheck'] <> "0") { ?>
                                                    <div class="col-12">
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="submenu<?= $idSubmenu ?>"><?= $c_submenu_localidade['submenu'] ?></label>
                                                        </div>
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="col-12">
