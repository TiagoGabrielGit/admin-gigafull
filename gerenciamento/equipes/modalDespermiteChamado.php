<script>
    function despermitirChamado(idCadastro2, nomeEquipe2, tipoChamado2) {
        ...
        <b>Tipo Chamado:</b> ${tipoChamado2}<br>
                                <b>Equipe:</b> ${nomeEquipe2}<br><br>
        Deseja remover a permissão dos usuários desta equipe abrir este tipo de chamado?`
