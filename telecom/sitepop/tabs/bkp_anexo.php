<div class="card-body">
  <div class="col-lg-12">
    <div class="row">
      ...
      <div class="col-4 d-flex justify-content-end">
        <button style="margin-top: 15px" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalAnexarImagem">
          Anexar Imagem
        </button>
      </div>
    </div>
  ...
  <?php
  $datesWithPhotos = array();
  foreach ($files as $file) {
    $ext = strtolower(pathinfo($file, PATHINFO_EXTENSION));
    if ($ext == "jpg" || $ext == "jpeg" || $ext == "png" || $ext == "gif") {
      $date = substr($file, -15, 8); // Extrair a data do nome do arquivo
      if (!in_array($date, $datesWithPhotos)) {
        $datesWithPhotos[] = $date;
      }
    }
  }
