...
if ($rowCount_permissions_submenu > 0) {
    ...
    if ($row['cred_priv'] == 1) {
        ...
        $sql_check_perm_user = "SELECT * FROM credenciais_email_privacidade_usuario WHERE credencial_id = :id AND usuario_id = :userId";
        ...
        $sql_check_perm_equipe = "SELECT * FROM credenciais_email_privacidade_equipe WHERE credencial_id = :id AND equipe_id IN (SELECT equipe_id FROM equipes_integrantes WHERE integrante_id = :userId)";
