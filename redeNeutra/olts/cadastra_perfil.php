...
$query_perfil = "INSERT INTO redeneutra_profile_parceiro (service, redeneutra_parceiro_id, redeneutra_olt_id, line_profile_id, srv_profile_id, active)
VALUES (:service, :redeneutra_parceiro_id, :redeneutra_olt_id, :line_profile_id, :srv_profile_id, '1')";
$stmt = $pdo->prepare($query_perfil);
$stmt->bindParam(':service', $dados['service']);
