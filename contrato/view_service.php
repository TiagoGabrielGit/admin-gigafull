                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a href="view_service.php?id=<?= $idContrato ?>"><button class="nav-link active" type="button">Serviços</button></a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalAdicionarService">
                                                    Adicionar Serviço
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr style="vertical-align: middle; text-align: center;" onclick="window.location.href='contrato_servico.php?id=<?= $c_contract_service['idCS'] ?>'">
