...
try {
    ...
    $stmt = $pdo->prepare("SELECT e.atributoEmpresaPropria as empresaPropria FROM empresas as e WHERE e.id = :empresaID");
    $stmt->bindParam(':empresaID', $empresaID, PDO::PARAM_INT);
    $stmt->execute();
    $resultado = $stmt->fetch(PDO::FETCH_OBJ);
    $empresaPropria = $resultado->empresaPropria;
    ...
    if ($empresaPropria == 1) { ?>
        ...
        <div class="accordion" id="accordionFlushExample">
            ...
            $sql_incidentes =
                ...
                WHERE i.active = 1 AND i.incident_type NOT IN ('100', '102')
