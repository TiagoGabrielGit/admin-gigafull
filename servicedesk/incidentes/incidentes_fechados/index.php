                        ...
                        <div class="accordion" id="accordionFlushExample">
                                    ...
                                    <div id="flush-collapse<?= $cont ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?= $cont ?>" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body colorAccordion">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-2">
                                                    <a href="/servicedesk/incidentes/view.php?id=<?= $id_incidente ?>&status=closed" title="Visualizar">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    ?>
                                    <li class="page-item"><a class="page-link" href="/servicedesk/incidentes/incidentes_fechados/index.php?pagina=1">Primeira Página</a></li>
                                    <?php
                                    ...
                                    ?>
                                            ...
                                            <li class="page-item"><a class="page-link" href="/servicedesk/incidentes/incidentes_fechados/index.php?pagina=<?= $i ?>"><?= $i ?></a></li>
                                    <?php
                                    ...
                                    <li class="page-item"><a class="page-link" href="/servicedesk/incidentes/incidentes_fechados/index.php?pagina=<?= $pags ?>">Última Página</a></li>
                                </ul>
