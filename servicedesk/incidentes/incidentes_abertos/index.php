                        ...
                        <div class="accordion" id="accordionFlushExample">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    ?>
                                    <li class="page-item"><a class="page-link" href="/servicedesk/incidentes/incidentes_abertos/index.php?pagina=1">Primeira Página</a></li>
                                    <?php
                                    ...
                                    <li class="page-item"><a class="page-link" href="/servicedesk/incidentes/incidentes_abertos/index.php?pagina=<?= $pags ?>">Última Página</a></li>
                                </ul>
