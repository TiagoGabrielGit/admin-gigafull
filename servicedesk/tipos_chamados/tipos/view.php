                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="mascara-tab" data-bs-toggle="tab" data-bs-target="#mascara" type="button" role="tab" aria-controls="mascara" aria-selected="true">Mascara Padrão</button>
                                            </li>
                                        </ul>
