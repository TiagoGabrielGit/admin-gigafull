                ...
                <section class="section">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    <h3 class="card-title">Status - <?= htmlspecialchars($status['descricao']) ?></h3>
                                </div>
                                <div class="col-5">
                                    <?php if ($status['default'] == 1) { ?>
                                        <br>
                                        <span><b>Este status é default do sistema, portanto sua edição é limitada.</b></span>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <form method="POST" action="processa/atualizar_status.php">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input required class="form-control" id="status" name="status" value="<?= htmlspecialchars($status['descricao']) ?>"></input>
                                    </div>
                                    <div class="col-3">
