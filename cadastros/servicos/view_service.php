...
if ($rowCount_permissions > 0) {
    ...
    $query_service = "
        SELECT service, description, item_service, active
        FROM service
        WHERE id = :id
    ";
...
?>
        ...
        <main id="main" class="main">
            ...
            <section class="section">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="processa/update_service.php">
                            <br>
                            <div class="row">
                                <div class="col-6">
                                    <label for="servico" class="form-label">Serviço</label>
                                    <input class="form-control" id="servico" name="servico" value="<?php echo htmlspecialchars($service['service']); ?>"></input>
                                </div>
                                <div class="col-6">
                                    <label for="descricao" class="form-label">Descrição</label>
                                    <input class="form-control" id="descricao" name="descricao" value="<?php echo htmlspecialchars($service['description']); ?>"></input>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="col-6">
                                        <label for="permite_item" class="form-label">Permite Item de Serviço</label>
                                        <select id="permite_item" name="permite_item" class="form-select">
                                            <option value="1" <?php if ($service['item_service'] == 1) echo 'selected'; ?>>Sim</option>
                                            <option value="0" <?php if ($service['item_service'] == 0) echo 'selected'; ?>>Não</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
