...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $idTransceiver = $_POST['idTransceiver'];
    ...
    $sql = "UPDATE produtos_transceiver SET fabricante_id = :fabricante, active = :ativo, modelo = :modelo, descricao = :descricao WHERE id = :id";
